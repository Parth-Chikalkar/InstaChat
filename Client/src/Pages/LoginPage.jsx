...
function LoginPage() {
  ...
  const { axios, setAuthUser, setToken } = useContext(AuthContext);
  ...
  return (
    <div className='w-full h-screen bg-black/90 flex flex-col md:flex-row justify-center items-center gap-10 md:gap-32 px-4 text-white'>
      ...
      <div className='bg-white/5 backdrop-blur-[20px] border border-white/10 p-8 rounded-xl w-full max-w-sm shadow-xl'>
        <p className='text-2xl font-medium mb-6 text-center'>Login</p>
        ...
        <p className='text-sm text-white/50 mt-6 text-center'>
          Don't have an account? <Link to="/signup" className='text-purple-400 hover:text-purple-300 font-semibold ml-1'>Signup</Link>
        </p>
      </div>
